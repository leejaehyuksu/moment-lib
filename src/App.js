  ...
  render() {
    return (
      <div>
        ...
        <p>2. 20010704T120854 =  {moment('20010704T120854').format('MMMM Do YYYY')} </p>
        <p>3. 20010704T120854 =  {moment('20010704T120854').format('dddd')} </p>
        <p>4. 20010704T120854 =  {moment('20010704T120854').format('MMM Do YY')} </p>
        ...
        <p>15. June 04 2001@12:09:56 =  {moment('June 04 2001@12:09:56').format('MMMM Do YYYY, h:mm:ss a')} </p>

        <h2>For local formats</h2>
        ...
        <h2>Calendar Time</h2>
        <p>1. 20010704T120854 =  {moment('20010704T120854').subtract(10, 'days').calendar()} </p>
        <p>2. 20010704T120854 =  {moment('20010704T120854').calendar()} </p>
        <p>3. 20010704T120854 =  {moment('20010704T120854').add(3, 'days').calendar()} </p>
